...
var assessment = {
  ...
  questionsList: [
    ...
    {questionHTML: '¿Quén es el fundador de Khan Academy? (Todo en Mayusculas)<p><img src="http://www.seti.cl/img/khan-academy.png" alt="Khan Academy" height=100 width=100 title="Khan Academy">',
